...
(
  SELECT 
    ...
    , CASE	
		WHEN d.pt = '0' THEN '0'
		WHEN d.pt = 'IS' THEN 'is'
		WHEN d.pt = '1' THEN '1'
		WHEN d.pt = '1M' THEN '1'
		WHEN d.pt = '1A' THEN '1a'
		WHEN d.pt = '1B' THEN '1b'
		WHEN d.pt = '1C' THEN '1c'
		WHEN d.pt = '2' THEN '2'
		WHEN d.pt = '3' THEN '3'
		WHEN d.pt = '4A' THEN '4a'
		WHEN d.pt = '4B' THEN '4b'
		WHEN d.pt = '4C' THEN '4c'
		WHEN d.pt = '4D' THEN '4d'
        ELSE NULL
      END AS TNM_value
    , d.cn AS code
    , d.incjr AS jaar
...
(
  SELECT 
    ...
    , CONCAT('p', '-', C_TNM1.TNM_version, 'AJCC/UICC-T', C_TNM1.TNM_value) AS concept_code
    , CONCAT('pT', C_TNM1.code, ' - ', C_TNM1.jaar) AS source_value
