...
(
  SELECT 
    ...
    , CASE
        WHEN d.ct = '0' THEN '0'
        WHEN d.ct = 'IS' THEN 'is'
        WHEN d.ct = '1' THEN '1'
        WHEN d.ct = '1A' THEN '1a'
        WHEN d.ct = '1B' THEN '1b'
        WHEN d.ct = '1C' THEN '1c'
		WHEN d.ct = '1M' THEN '1'
        WHEN d.ct = '2' THEN '2'
        WHEN d.ct = '3' THEN '3'
        WHEN d.ct = '4A' THEN '4a'
        WHEN d.ct = '4B' THEN '4b'
        WHEN d.ct = '4C' THEN '4c'
        WHEN d.ct = '4D' THEN '4d'
        ELSE NULL
      END AS TNM_value
    , d.ct AS code
    , d.incjr AS jaar
...
(
  SELECT 
    ...
    , CONCAT('c', '-', C_TNM1.TNM_version, 'AJCC/UICC-T', C_TNM1.TNM_value) AS concept_code
    , CONCAT('cT', C_TNM1.code, ' - ', C_TNM1.jaar) AS source_value
