...
(
  SELECT 
    ...
    , CASE
	    WHEN d.cn = '0' THEN '0'
        WHEN d.cn = '1' THEN '1'
        WHEN d.cn = '2A' THEN '2a'
        WHEN d.cn = '2B' THEN '2b'
        WHEN d.cn = '3A' THEN '3a'
        WHEN d.cn = '3B' THEN '3b'
        WHEN d.cn = '3C' THEN '3c'
        ELSE NULL
      END AS TNM_value
    , d.cn AS code
    , d.incjr AS jaar
...
(
  SELECT 
    ...
    , CONCAT('c', '-', C_TNM1.TNM_version, 'AJCC/UICC-N', C_TNM1.TNM_value) AS concept_code
    , CONCAT('cN', C_TNM1.code, ' - ', C_TNM1.jaar) AS source_value
