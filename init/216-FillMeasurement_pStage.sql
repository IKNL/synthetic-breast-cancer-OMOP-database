...
(
  SELECT 
    ...
    , CASE 
      ...
      END AS TNM_version
    ,  CASE
        WHEN d.pstadium = '0' THEN '0'
        WHEN d.pstadium = '1A' THEN '1A'
		WHEN d.pstadium = '1B' THEN '1B'
        WHEN d.pstadium = '2A' THEN '2A'
        WHEN d.pstadium = '2B' THEN '2B'
        WHEN d.pstadium = '3A' THEN '3A'
        WHEN d.pstadium = '3B' THEN '3B'
        WHEN d.pstadium = '3C' THEN '3C'
        WHEN d.pstadium = '4' THEN '4'
        ELSE NULL
      END AS TNM_value
    , d.pstadium AS code
    , d.incjr AS jaar
...
(
  SELECT 
    ...
    , CONCAT('p-', C_TNM1.TNM_version, 'AJCC/UICC-Stage-', C_TNM1.TNM_value) AS concept_code
    , CONCAT('pStage', C_TNM1.code, ' - ', C_TNM1.jaar) AS source_value
